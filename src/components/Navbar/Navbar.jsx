        ...
        <div className='content'>
          ...
          <FontAwesomeIcon className="barcontrole" icon={faBars} onClick={(e) => { Handel(e) }} />
            <ul ref={Listref}>
              ...
              {localStorage.getItem("auth-token") ? <li className="login-mobile" onClick={() => { localStorage.removeItem("auth-token"); window.location.replace("/login") }}><button>Logout</button></li> : <Link style={{ textDecoration: 'none' }} to="login"><li className="login-mobile"><button>Login</button></li></Link>}
            </ul>
